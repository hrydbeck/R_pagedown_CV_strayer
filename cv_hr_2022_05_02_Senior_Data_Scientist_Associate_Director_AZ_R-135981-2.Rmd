...
params:
  pdf_mode:
    value: false
  cv_version:
    value: "_hr_2022_05_02_Senior_Data_Scientist_Associate_Director_AZ_R-135981-2"
output:
...
```{r}
# Note the special double pipe so we modify the CV object in place
CV %<>% print_text_block("objective_2022_05_02_Senior_Data_Scientist_Associate_Director_AZ_R-135981-2") 
```
