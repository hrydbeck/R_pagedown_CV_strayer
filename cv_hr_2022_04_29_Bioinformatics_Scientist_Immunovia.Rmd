...
params:
  pdf_mode:
    value: false
  cv_version:
    value: "_hr_2022_04_29_Bioinformatics_Scientist_Immunovia"
output:
...
```{r}
# Note the special double pipe so we modify the CV object in place
CV %<>% print_text_block("objective_2022_04_28_Bioinformatiker_Core_Facilities_GU") 
```

```{r}
# Note the special double pipe so we modify the CV object in place
CV %<>% print_text_block("relevantCompetences_2022_04_29_Bioinformatics_Scientist_Immunovia") 
```
