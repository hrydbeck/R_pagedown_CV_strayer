...
params:
  pdf_mode:
    value: false
  cv_version:
    value: "_hr_2022_04_24_Bioinf_OlsAro_Crop_Biotech"
output:
...
```{r}
# Note the special double pipe so we modify the CV object in place
CV %<>% print_text_block("profile_2022_04_24_Bioinf_OlsAro_Crop_Biotech") 
```


```{r}
# Note the special double pipe so we modify the CV object in place
CV %<>% print_text_block("objective_2022_04_24_Bioinf_OlsAro_Crop_Biotech") 
```

```{r}
# Note the special double pipe so we modify the CV object in place
CV %<>% print_text_block("relevantCompetences_2022_04_24_Bioinf_OlsAro_Crop_Biotech") 
```
